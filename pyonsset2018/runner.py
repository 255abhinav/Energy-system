...
#DELETE THIS LATER
specs_path = '/home/255abhinav/PycharmProjects/testproject/pyonsset2018/specs.xlsx'
...
if choice == 0:
    ...
    base_dir = '/home/255abhinav/PycharmProjects/testproject/pyonsset2018/Lumenia.csv'
    #messagebox.showinfo('OnSSET', 'Browse to result folder and name the calibrated file')
    #output_dir = filedialog.asksaveasfilename()
    output_dir = '/home/255abhinav/PycharmProjects/testproject/1_calibrate'
